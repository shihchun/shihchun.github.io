...
<script id="asciicast-eOFGEwuL947wtvWKrFTR4pnwy" src="https://asciinema.org/a/eOFGEwuL947wtvWKrFTR4pnwy.js" async></script>

> Pyviz issue in this version 3.29 ref [here](https://blog.csdn.net/qq_31676673/article/details/88107454)
> AttributeError: ‘gi.repository.GooCanvas’ object has no attribute 'LineDash'
> `line_dash=GooCanvas.LineDash()` cange to `line_dash=GooCanvas.CanvasLineDash.newv()`
